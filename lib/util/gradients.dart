...
final gradients = [
    ...
    _linearGradientFrom(HexColor('#673f8c'), HexColor('#93608c')),
    _linearGradientFrom(HexColor('#bdc3c7'), HexColor('#2c3e50')),
    _linearGradientFrom(HexColor('#f9ff5e'), HexColor('#a8e063')),
    ...
    _linearGradientFrom(HexColor('#c33764'), HexColor('#4655db')),
